...
dbsetup.packagesetup = () => {
    return connection.getpackageCollection().then((myCollection) => {
        return myCollection.deleteMany().then((data) => {
            return myCollection.insertMany(packageDb).then((data) => {
                if (data) {
...
dbsetup.destinationsetup=()=>{
    return connection.getdestinationCollection().then((myCollection) => {
        return myCollection.deleteMany().then((data) => {
            return myCollection.insertMany(destinationDb).then((data) => {
                if (data) {
                    return "Insertion Successfull"
                } else {
                    throw new Error("Insertion failed")
